...
namespace SteamPP.Services.GBE
{
    public class GoldbergLogic
    {
        ...
        private void ExtractAndCopyDependencies(string stagingRoot, string settingsPath)
        {
            ...
            ExtractEmbeddedResource("SteamPP.Resources.GBE.dependencies.steam_api64.dll", Path.Combine(stagingRoot, "steam_api64.dll"));
            _log("✓ Extracted steam_api64.dll", false);

            ExtractEmbeddedResource("SteamPP.Resources.GBE.dependencies.steamclient64.dll", Path.Combine(stagingRoot, "steamclient64.dll"));
            ...
            try
            {
                ...
                string soundResourcePrefix = "SteamPP.Resources.GBE.sounds.";
