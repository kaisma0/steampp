...
namespace SteamPP.Services
{
    public class LuaFileManager
    {
        ...
        public LuaFileManager(ISteamService steamService)
        {
            _steamService = steamService;
        }

        private string GetStPluginPath() => _steamService.GetStPluginPath() ?? "";
        ...
        public (bool success, string message) DisableGame(string appId)
        {
            ...
            var disabledFile = Path.Combine(stpluginPath, $"{appId}.lua.disabled");
